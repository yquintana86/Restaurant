...
public sealed class WaiterError
{
    ...
    public static ApiOperationError RelatedShiftNotFound(string name) => ApiOperationError.NotFound(nameof(RelatedShiftNotFound), $"Waiter with name: {name} has no shift associated and a waiter requires a shift");
